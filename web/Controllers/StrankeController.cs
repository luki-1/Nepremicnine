...
namespace web.Controllers
{
    public class StrankeController : Controller
    {
        ...
        public StrankeController(NepremicnineContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("ID,LastName,FirstName")] Stranka stranka)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,LastName,FirstName")] Stranka stranka)
        {
            if (id != stranka.ID)
            {
                return NotFound();
